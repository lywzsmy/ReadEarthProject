...
namespace Readearth.Code
{
    public class OperatorProvider
    {
        ...
        private string LoginUserKey = "Readearth_loginuserkey_2016";
        ...
        public void AddCurrent(OperatorModel operatorModel)
        {
            ...
            WebHelper.WriteCookie("Readearth_mac", Md5.md5(Net.GetMacByNetworkInterface().ToJson(), 32));
            WebHelper.WriteCookie("Readearth_licence", Licence.GetLicence());
        }
