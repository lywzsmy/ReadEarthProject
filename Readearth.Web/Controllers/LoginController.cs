...
using Readearth.Application.SystemSecurity;
using System;
...
namespace Readearth.Web.Controllers
{
    public class LoginController : Controller
    {
        ...
        public ActionResult CheckLogin(string username, string password, string code)
        {
            ...
            try
            {
                if (Session["Readearth_session_verifycode"].IsEmpty() || Md5.md5(code.ToLower(), 16) != Session["Readearth_session_verifycode"].ToString())
                {
